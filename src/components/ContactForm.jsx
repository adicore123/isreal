  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-3">
      ...
      <button
        ...
        className="bg-[#F7444E] hover:bg-[#de3d46] text-white px-6 py-3.5 md:py-4 rounded-xl font-bold text-sm md:text-base disabled:opacity-50 disabled:cursor-not-allowed focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#F7444E] flex items-center justify-center shrink-0 transition-colors shadow-md coral-glow outline-none"
      >
