  ...
  return (
    <>
      ...
      <a
        ...
        className="fixed bottom-5 left-5 z-[100] bg-[#06d6a0] text-white p-3.5 rounded-full shadow-lg flex items-center justify-center hover:bg-[#05b88a] transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 outline-none focus-visible:ring-[#002C3E]"
      ...
      <a
        ...
        className="fixed bottom-5 right-5 z-[100] bg-[#F7444E] hover:bg-[#de3d46] text-white p-3.5 rounded-full shadow-lg coral-glow flex items-center justify-center transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 outline-none focus-visible:ring-[#002C3E]"
        title="חייגו עכשיו"
      ...
      >
        <div className="container mx-auto px-5 md:px-6 flex justify-between items-center">
          ...
          <button
            className="lg:hidden p-2 rounded-xl text-[#002C3E] hover:bg-[#F7F8F3] transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 outline-none focus-visible:ring-[#002C3E]"
          ...
          >
            {isMobileMenuOpen ? (
              <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5} aria-hidden="true">
