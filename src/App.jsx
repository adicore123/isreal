...
const galleryImported = {
  ...import.meta.glob("./assets/gallery/*.{jpg,jpeg,jpe,png,webp}", {
    eager: true,
    import: "default",
  }),
  ...import.meta.glob("./assets/gallery/*.{JPG,JPEG,JPE,PNG,WEBP}", {
  ...
  ...import.meta.glob("../images/*.{jpg,jpeg,jpe,png,webp}", {
    eager: true,
    import: "default",
  }),
  ...import.meta.glob("../images/*.{JPG,JPEG,JPE,PNG,WEBP}", {
...
const servicesList = [
  {
    title: "אבחון תקלות מקצועי ומדויק",
    icon: Icons.ServiceSearch,
    tone: "teal",
  },
  { title: "תיקוני חשמל ותקלות מורכבות", icon: Icons.Electric, tone: "coral" },
  {
    title: "חילוץ ברגים תקועים / שבורים",
    icon: Icons.ServiceScrewdriver,
    tone: "muted",
  },
  ...
  {
    title: "תחזוקה שוטפת וטיפולים מקצועיים",
    icon: Icons.ServiceMaintenance,
    tone: "teal",
  },
];
...
const galleryFallbackPublic = [
  {
    ...
    alt: "תיקון קורקינט חשמלי — אבחון ותיקון במעבדה",
  },
  {
    src: "/images/work-02.jpg",
    alt: "תיקון אופניים חשמליים — מערכת חשמל בכלי רכיב",
  },
  {
    src: "/images/work-03.jpg",
    alt: "תיקון מנוע והילוך לקורקינט או אופניים חשמליים",
  },
  { src: "/images/work-04.jpg", alt: "הלחמה וחיווט מקצועי לכלים חשמליים" },
  {
    src: "/images/work-05.jpg",
    alt: "הרכבה והחלפת רכיב — שירות טכנאי קורקינטים",
  },
  {
    src: "/images/work-06.jpg",
    alt: "תיעוד עבודות שטח ומעבדה — תיקון כלים חשמליים",
  },
];
...
const whyUsItems = [
  {
    text: "ניסיון וידע מקצועי בתחום הכלים החשמליים",
    Icon: Icons.WhyUsAward,
    accent: "teal",
  },
  {
    text: "התמחות בתקלות מורכבות ותיקוני חשמל",
    Icon: Icons.ServiceEngineWire,
    accent: "coral",
  },
  {
    text: "שירות מקצועי לקורקינטים, אופניים חשמליים, טרקטורונים וקלנועיות",
    kind: "fleet",
    accent: "teal",
  },
  {
    text: "התמחות באופניים חשמליים מכל הסוגים",
    Icon: Icons.Bike,
    accent: "coral",
  },
  {
    text: "עבודה יסודית, מדויקת ואמינה",
    Icon: Icons.ServiceGear,
    accent: "teal",
  },
  { text: "שירות מהיר, מקצועי ואישי", Icon: Icons.WhyUsTimer, accent: "coral" },
  {
    text: "פתרונות ללקוחות פרטיים ולעסקים",
    Icon: Icons.WhyUsUsers,
    accent: "teal",
  },
];
...
const accentWhyUsIcon = {
  ...
  coral:
    "bg-gradient-to-br from-[#F7444E] to-[#c9363f] text-white shadow-lg shadow-[#F7444E]/25",
};

function WhyUsFleetGlyph({ className }) {
  return (
    <div
      className={`grid grid-cols-2 gap-0.5 place-items-center text-current ${className || ""}`}
    >
  ...
  return (
    <>
      ...
      <a
        ...
        className="fixed bottom-5 left-5 z-[100] bg-[#06d6a0] text-white p-3.5 rounded-full shadow-lg flex items-center justify-center hover:bg-[#05b88a] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#06d6a0]"
      ...
      <a
        ...
        className="fixed bottom-5 right-5 z-[100] bg-[#F7444E] hover:bg-[#de3d46] text-white p-3.5 rounded-full shadow-lg coral-glow flex items-center justify-center transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#F7444E]"
        title="חייגו עכשיו"
      ...
      >
        <div className="container mx-auto px-5 md:px-6 flex justify-between items-center">
          ...
          <nav
            className="hidden lg:flex gap-8 font-semibold text-[#002C3E]/70"
            aria-label="ניווט ראשי"
          >
            <a href="#about" className="hover:text-[#002C3E] transition-colors">
              נעים להכיר
            </a>
            <a
              href="#gallery"
              className="hover:text-[#002C3E] transition-colors"
            >
              מהשטח
            </a>
            <a
          ...
          <button
            className="lg:hidden p-2 rounded-xl text-[#002C3E] hover:bg-[#F7F8F3] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#78BCC4]"
      ...
      >
          ...
          <div className="container mx-auto px-5 md:px-6 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                ...
                <span className="wow-underline inline-block mt-2 md:mt-3">
                  לכל סוגי הכלים החשמליים
                </span>
              </h1>

              <p className="text-lg sm:text-xl md:text-2xl text-white/80 mb-10 md:mb-12 max-w-2xl mx-auto leading-relaxed font-normal">
                טכנאי קורקינטים חשמליים ואופניים חשמליים בישראל — אבחון מקצועי,
                תיקון סוללות ומנועים, צמות, חשמל והרכבות. שירות לפרטיים ולעסקים.
              </p>
              ...
              <div className="flex flex-wrap justify-center gap-2 md:gap-3 text-xs md:text-sm font-bold">
                {["קורקינטים", "אופניים חשמליים", "טרקטורונים", "קלנועיות"].map(
                  (tag, i) => (
                    <div
                      key={i}
                      className="bg-white/10 backdrop-blur-sm text-white border border-white/20 px-5 py-2 rounded-full"
                    >
                      {tag}
                    </div>
                  ),
        ...
        >
          <div
            className="animate-marquee whitespace-nowrap flex flex-nowrap items-center w-max"
            dir="ltr"
          >
        ...
        <AnimatedSection id="about" className="bg-[#F7F8F3]">
          <div className="container mx-auto px-5 md:px-6">
            <div className="text-center mb-10 md:mb-12">
              <h2 className="text-3xl md:text-5xl font-black text-[#002C3E] mb-4 md:mb-6">
                נעים להכיר, ישראל
              </h2>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <h3 className="text-lg md:text-xl font-bold text-[#002C3E] mb-2 leading-snug">
                        {card.title}
                      </h3>
                      <p className="text-base md:text-lg text-[#002C3E]/80 font-medium leading-relaxed">
                        {card.body}
                      </p>
                    </div>
                  </div>
        ...
        >
          <div className="container mx-auto px-5 md:px-6">
            <div className="text-center mb-8 md:mb-10">
              <h2
                id="gallery-heading"
                className="text-3xl md:text-5xl font-black text-[#002C3E] mb-4 md:mb-6"
              >
                מהשטח — צילומי עבודה
              </h2>
              <p className="text-[#78BCC4] text-lg md:text-xl font-medium mb-4 md:mb-6">
                תיעוד מקצועי מתוך המעבדה והשטח
              </p>
              <div className="w-16 h-1 bg-[#F7444E] mx-auto rounded-full" />
            </div>
          </div>
          {workGalleryPhotos.length > 0 ? (
            <WorkGalleryCards photos={workGalleryPhotos} />
          ) : null}
          {galleryFromBundled.length === 0 ? (
            <p className="text-center text-[#002C3E]/70 font-medium text-sm md:text-base px-6 pb-10 max-w-2xl mx-auto leading-relaxed">
              ...
              <span className="font-mono bg-[#F7F8F3] px-1.5 py-0.5 rounded text-[#002C3E]">
                images
              </span>{" "}
              בשורש הפרויקט או ב־
              <span className="font-mono bg-[#F7F8F3] px-1.5 py-0.5 rounded text-[#002C3E]">
        ...
        <AnimatedSection
          id="services"
          className="bg-[#002C3E] text-white"
          ...
          <div className="container mx-auto px-5 md:px-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 md:mb-16 gap-4 border-b border-white/10 pb-6 md:pb-8">
              <div>
                ...
                <p className="text-[#78BCC4] text-lg md:text-xl font-medium">
                  מעטפת תיקונים מושלמת לכל כלי
                </p>
              </div>
              <Icons.Settings
                className="w-10 h-10 text-white/10 hidden md:block"
                aria-hidden="true"
              />
            </div>
        ...
        <AnimatedSection id="audiences" className="bg-white">
          <div className="container mx-auto px-5 md:px-6">
            <div className="text-center mb-12 md:mb-16">
              <h2 className="text-3xl md:text-5xl font-black text-[#002C3E] mb-6">
                שירות לפרטיים ולעסקים
              </h2>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
              <div className="bg-[#F7F8F3] p-8 md:p-12 rounded-2xl border border-[#002C3E]/5 flex flex-col justify-center">
                ...
                <h3 className="text-2xl md:text-3xl font-black text-[#002C3E] mb-3">
                  שירות עד הבית
                  <br />
                  <span className="text-[#78BCC4] text-xl md:text-2xl">
                    ללקוחות פרטיים
                  </span>
                </h3>
                <p className="text-base md:text-lg text-[#002C3E]/70 font-medium leading-relaxed">
                  פתרון נוח, מהיר ומקצועי – בלי צורך לשנע את הכלי. הטכנאי מגיע
                  עד אליכם.
                </p>
              </div>
              <div className="bg-[#002C3E] p-8 md:p-12 rounded-2xl flex flex-col justify-center shadow-lg relative overflow-hidden">
                ...
                <h3 className="text-2xl md:text-3xl font-black text-white mb-3 relative z-10">
                  שירות מקצועי
                  <br />
                  <span className="text-[#F7444E] text-xl md:text-2xl">
                    לחנויות ועסקים
                  </span>
                </h3>
                <p className="text-base md:text-lg text-white/70 font-medium leading-relaxed relative z-10">
                  שירות מקצועי לחנויות, משווקים ובתי עסק בתחום הכלים החשמליים –
                  כולל תיקונים, תחזוקה, הרכבות וטיפול בתקלות מורכבות.
                </p>
        ...
        <AnimatedSection id="contact" className="bg-white">
          <div className="container mx-auto px-5 md:px-6 max-w-3xl text-center">
            <h2 className="text-4xl md:text-6xl font-black text-[#002C3E] mb-4 md:mb-6">
              צריכים תיקון?
            </h2>
            ...
            <div className="flex flex-wrap justify-center items-center gap-2 md:gap-3 mb-10 text-[#002C3E]/80 font-medium text-sm md:text-base">
              <span>קורקינטים</span>
              <span className="text-[#002C3E]/20">|</span>
              <span>אופניים חשמליים</span>
              <span className="text-[#002C3E]/20">|</span>
              <span>טרקטורונים</span>
              <span className="text-[#002C3E]/20">|</span>
              <span>קלנועיות</span>
            </div>
            <div className="bg-[#F7F8F3] p-6 md:p-10 rounded-2xl border border-[#002C3E]/5 shadow-sm inline-block w-full text-center">
              <p className="text-lg md:text-xl font-bold text-[#002C3E] mb-1 md:mb-2">
                נשמח לעמוד לשירותכם
              </p>
              <p className="text-sm md:text-base text-[#002C3E]/80 mb-6 md:mb-8">
