    ...
    <>
      ...
      >
        <div className="container mx-auto px-5 md:px-6 flex justify-between items-center">
          ...
          <button
            className="lg:hidden p-2 rounded-xl text-[#002C3E] hover:bg-[#F7F8F3] transition-colors focus-visible:outline focus-visible:outline-4 focus-visible:outline-offset-2 focus-visible:outline-[#78BCC4]"
